...
class Wp_Scss_Settings
{
    ...
    public function create_admin_page()
    {
        ...
        <div class="wrap">
            ...
            <p>
              ...
              <br/>
              <span class="author">By: <a href="http://jasonlusk.com" target="_blank">Jason Lusk</a></span>
              <br/>
              <span class="repo">Help & Issues: <a href="https://github.com/mpalpha" target="_blank">Github</a></span>
            </p>        
    ...
    {        
        ...
        add_settings_field(
            'wpscss_scss_dir', // ID
            'Scss Location<br />example: "/library/scss/"', // Title 
        ...
        add_settings_field(
            'wpscss_css_dir', 
            'CSS Location<br />example: "/library/css/"', 
    ...
    public function print_paths_info() {
        print 'Add the paths to your directories below. Paths should start with the root of your theme.';
    }
